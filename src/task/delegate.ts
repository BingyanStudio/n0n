	...
	const history: DomainMessage[] = [
		{
			...
			content: [
				...
				envLine,
				shellHint,
				"PLANNING: Before any action, break the task into an Objective and Key Results (OKR). Then call `reminder` with your OKR summary to track progress. When a reminder fires, update it with current progress in your next tool call.",
